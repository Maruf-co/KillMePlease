/**
 * The SymbolCapitalR class extends abstract class Symbol, implements
        ...
        for (int i = 1; i <= sightDistance; i++) {
            if (position.column + i < 10){ // Checking for moving symbol Right
                ...
                if (WorldController.world.containsKey(tmpPosition) && // Checking whether key exist
                        ...
                        (WorldController.world.get(tmpPosition).get(0) instanceof SymbolCapitalS || // Checking whether symbol of weaker type
                                WorldController.world.get(tmpPosition).get(0) instanceof SymbolSmallS)){ // Checking whether symbol of weaker type
